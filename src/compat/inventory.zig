...
test "buildInventoryReportAlloc summarizes the shortlist boundary" {
    ...
    try std.testing.expectEqual(@as(usize, 15), report.boundary.total_shortlist_targets);
    ...
    try std.testing.expectEqual(@as(usize, 13), report.family_coverage.len);
    ...
    try std.testing.expectEqual(targets.TargetFamily.haskell, report.family_coverage[7].family);
    ...
    try std.testing.expectEqual(targets.TargetFamily.bash, report.family_coverage[8].family);
    ...
    try std.testing.expectEqual(targets.TargetFamily.parse_table_conflict, report.family_coverage[9].family);
    try std.testing.expectEqual(@as(usize, 1), report.family_coverage[9].control_count);
    try std.testing.expectEqual(targets.TargetFamily.bracket_lang, report.family_coverage[10].family);
    try std.testing.expectEqual(@as(usize, 1), report.family_coverage[10].passed_count);
    try std.testing.expectEqual(targets.TargetFamily.hidden_external_fields, report.family_coverage[11].family);
    try std.testing.expectEqual(@as(usize, 2), report.family_coverage[11].passed_count);
    try std.testing.expectEqual(targets.TargetFamily.mixed_semantics, report.family_coverage[12].family);
