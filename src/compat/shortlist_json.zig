...
pub const ShortlistEntry = struct {
    ...
    scanner_boundary_check_mode: targets.ScannerBoundaryCheckMode,
    real_external_scanner_proof_scope: targets.RealExternalScannerProofScope,
...
fn collectShortlistEntriesAlloc(
    ...
    for (shortlist, 0..) |target, index| {
        entries[index] = .{
            ...
            .scanner_boundary_check_mode = target.scanner_boundary_check_mode,
