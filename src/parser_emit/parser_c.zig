...
pub fn writeParserC(
    ...
    try writer.writeAll("#define TS_SYMBOL_KIND_NON_TERMINAL 1\n");
    try writer.writeAll("#define TS_SYMBOL_KIND_TERMINAL 2\n");
    try writer.writeAll("#define TS_SYMBOL_KIND_EXTERNAL 3\n");
