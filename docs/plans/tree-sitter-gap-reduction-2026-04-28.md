...
now regenerated by the artifact refresh script and records the current large
grammar boundary accurately: JavaScript remains prepare-only, while Python,
TypeScript, and Rust have bounded routine coarse serialize-only parser proofs.
